    ...
    public class DAL
    {
        public Response register(Users users, SqlConnection connection)
        {
            ...
            if (i > 0)
            {
                ...
                response.StatusMessage = "User resigtered sucessfully";
            }
            else
            {
                response.StatusCode = 100;
                response.StatusMessage = "User resigtration failed";
            }
            return response;
        }
        ...
        public Response login(Users users, SqlConnection connection)
        {
            ...
            da.SelectCommand.Parameters.AddWithValue("@Email", users.Password);
        ...
        public Response updateProfile(Users users, SqlConnection connection)
        {
            ...
            {
                response.StatusCode = 100;
                response.StatusMessage = "Some errors occured. Try after sometimes";
            }
        ...
        {
            Response response = new Response();
            SqlCommand cmd = new SqlCommand("sp_placeOrer", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                response.StatusCode = 100;
                response.StatusMessage = "Order could not be placed failed";
            }
            return response;
        }
    }
